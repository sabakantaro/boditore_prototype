...
ActiveRecord::Schema.define(version: 2021_12_19_075319) do
  ...
  create_table "tag_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "post_id", null: false
